...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      id: const obx_int.IdUid(1, 6484973541583056982),
      name: 'Task',
      lastPropertyId: const obx_int.IdUid(5, 8081934940140132777),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 3097519385247050216),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 6744213749231389899),
            name: 'taskname',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 1140384068924458810),
            name: 'description',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(4, 4763428658981425790),
            name: 'taskTime',
            type: 10,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(5, 8081934940140132777),
            name: 'iscompleted',
            type: 1,
            flags: 0)
      ],
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      entities: _entities,
      lastEntityId: const obx_int.IdUid(1, 6484973541583056982),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    Task: obx_int.EntityDefinition<Task>(
        ...
        objectToFB: (Task object, fb.Builder fbb) {
          ...
          fbb.addInt64(3, object.taskTime.millisecondsSinceEpoch);
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final taskTimeParam = DateTime.fromMillisecondsSinceEpoch(
